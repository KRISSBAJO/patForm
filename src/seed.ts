...
async function main(): Promise<void> {
   ...
   * The pack catalogue.
   *
   * The builder's "New process" dialog opens on "From a pack" and said "No
   * packs available", because nothing ever published one — a first screen
   * whose default tab is empty. These are built-in, so every workspace sees
