  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,600;9..144,700&family=IBM+Plex+Mono:wght@400;500&family=Instrument+Sans:wght@400;500;600&family=Dancing+Script:wght@500&family=Great+Vibes&family=Caveat:wght@500&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>{children}</body>
